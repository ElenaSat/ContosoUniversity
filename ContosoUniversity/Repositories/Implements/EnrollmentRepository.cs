...
namespace ContosoUniversity.Repositories.Implements
{
    public class EnrollmentRepository : GenericRepository<Enrollment>, IEnrollmentRepository
    {
        ...
        public new async Task<List<Enrollment>> GetAll() {
            ...
            var listEnrollments = await schoolContext.Enrollments.Include(x => x.Course).Include(x => x.Student).ToListAsync();

            /*  var listEnrollments2 = await (from enrollments in schoolContext.Enrollments
